...
FunctionPointer(void, LoadTexture, (GliTexture* tex, const char* textureName, void* buffer), 0x426050);
FunctionPointer(void, LoadTextureWithCaps, (GliTexture* tex, const char* textureName, void* buffer), 0x426320);
